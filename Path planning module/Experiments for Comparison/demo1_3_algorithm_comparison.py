...
excel_file1 = r'Path planning module\Experiments for Comparison\fusionDQN_x9522_y14992.xlsx'  # fusion path, add your trainning path
...
excel_file2 = r'Path planning module\Experiments for Comparison\DQN_x9522_y14992.xlsx'  # DQN path, add your trainning file path
...
excel_file_3 = r'Path planning module\Experiments for Comparison\Astar_x9522_y14992.xlsx'  # Astar path, add your trainning file path
...
plt.savefig(r'Path planning module\Experiments for Comparison\figure_comparison.eps')## replace it with your file path
plt.savefig(r'Path planning module\Experiments for Comparison\figure_comparison.pdf')
plt.savefig(r'Path planning module\Experiments for Comparison\figure_comparison.png')
