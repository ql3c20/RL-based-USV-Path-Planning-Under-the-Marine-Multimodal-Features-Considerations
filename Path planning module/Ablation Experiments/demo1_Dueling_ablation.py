...
#fusion
excel_file1 = r'Path planning module\Experiments for Comparison\fusionDQN_x9522_y14992.xlsx'  # replace it with your file path
...
ax.plot(xy_smooth[0], xy_smooth[1], color=(225/255,226/255,228/255), linewidth=2,linestyle='--')




#No Dueling
excel_file1 = r'Path planning module\Ablation Experiments\PDDQN_path1_x9522_y14992.xlsx'  # replace it with your file path
df1 = pd.read_excel(excel_file1)
x1 = df1.iloc[:, 0]
y1 = df1.iloc[:, 1]
angle = df1.iloc[:, 2]
...
u_new = np.linspace(0, 1, 1000)
xy_smooth = splev(u_new, tck)
ax.plot(xy_smooth[0], xy_smooth[1], color=(221/255, 69/255, 178/255), linewidth=2)
...
plt.savefig(r'Path planning module\Ablation Experiments\figure_ablation_demo.eps', format='eps') #replace it with your file path
plt.savefig(r'Path planning module\Ablation Experiments\figure_ablation_demo.pdf', format='pdf')
plt.savefig(r'Path planning module\Ablation Experiments\figure_ablation_demo.jpg', format='jpg')
plt.show()
