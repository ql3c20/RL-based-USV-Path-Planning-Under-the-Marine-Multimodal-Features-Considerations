...
# ECDIS
# #replace it with your multimodal characteristic marine environment
...
# 33%
# replace your trainning file path
excel_file1 = r'Path planning module\Experiments for Testing Generalization Ability\fusionDQN_trainning_process_firststage_x9522_y14992.xlsx'  # 替换为你的 Excel 文件路径
...
ax.plot(xy_smooth[0], xy_smooth[1], color=(225/255,226/255,228/255), linewidth=1.8,linestyle='--')

# 67%
# replace your trainning file path
excel_file1 = r'Path planning module\Experiments for Testing Generalization Ability\fusionDQN_trainning_process_secondstage_x9522_y14992.xlsx'  # 替换为你的 Excel 文件路径
df1 = pd.read_excel(excel_file1)
x1 = df1.iloc[:, 0]
y1 = df1.iloc[:, 1]
angle = df1.iloc[:, 2]
...
# 100%
# replace your trainning file path
excel_file1 = r'Path planning module\Experiments for Testing Generalization Ability\fusionDQN_trainning_process_thirdstage_x9522_y14992.xlsx'  # 替换为你的 Excel 文件路径
df1 = pd.read_excel(excel_file1)
x1 = df1.iloc[:, 0]
y1 = df1.iloc[:, 1]
angle = df1.iloc[:, 2]
...
u_new = np.linspace(0, 1, 1000)
xy_smooth = splev(u_new, tck)
ax.plot(xy_smooth[0], xy_smooth[1], color=(255/255,0/255,0/255), linewidth=2.3)
...
plt.savefig(r'Path planning module\Experiments for Testing Generalization Ability\path_trainning_process_visualization.eps', format='eps')
plt.savefig(r'path planning module\Experiments for Testing Generalization Ability\path_trainning_process_visualization.pdf', format='pdf')
plt.savefig(r'path planning module\Experiments for Testing Generalization Ability\path_trainning_process_visualization.jpg', format='jpg')
plt.show()
