...
excel_file1 = r'Path planning module\Experiments for Comparison\fusionDQN_x9522_y14992.xlsx'  # fusion path, add your trainning file path
...
plt.savefig(r'Path planning module\Experiments for Testing Generalization Ability\path_visualization.eps')#replace it with your file path
plt.savefig(r'Path planning module\Experiments for Testing Generalization Ability\path_visualization.pdf')
plt.savefig(r'Path planning module\Experiments for Testing Generalization Ability\path_visualization.png')
